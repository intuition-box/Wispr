  ...
  return (
    <div className="flex flex-col min-h-screen bg-bg">
      ...
      <section className="px-7 pt-8 pb-10 max-w-[480px] mx-auto w-full">
        <h2 className="font-display text-[22px] text-ink mb-7">How it works</h2>
        <div className="flex flex-col gap-4 stagger">
          {STEPS.map((step, i) => (
            ...
            >
              <span className="text-xl w-10 h-10 rounded-xl bg-bg flex items-center justify-center shrink-0">
                {step.icon}
              </span>
      ...
      <section className="px-7 pb-8 max-w-[480px] mx-auto w-full">
        <div className="flex items-baseline justify-between mb-4">
          <h2 className="font-display text-[22px] text-ink">7 roles</h2>
        ...
        <div className="flex flex-wrap gap-2 stagger">
          {ROLES.map((role) => (
            <span
              key={role.label}
              className="animate-fade-up flex items-center gap-1.5 bg-card border border-line rounded-full px-3.5 py-2 text-[13px] font-medium text-ink shadow-xs hover:shadow-sm hover:-translate-y-px transition-all duration-200 cursor-default"
            >
      ...
      <section className="px-7 pb-10 max-w-[480px] mx-auto w-full">
        <h2 className="font-display text-[22px] text-ink mb-4">4 AI levels</h2>
      ...
      <div className="sticky bottom-0 px-7 py-5 max-w-[480px] mx-auto w-full">
        <div className="glass rounded-2xl p-4 border border-line shadow-lg">
          <button
            ...
            className="w-full bg-accent hover:bg-accent-hover text-ink-inverse font-semibold text-[15px] py-4 rounded-xl transition-all duration-300 shadow-md hover:shadow-lg active:scale-[0.98]"
          >
            Start the quiz →
          </button>
